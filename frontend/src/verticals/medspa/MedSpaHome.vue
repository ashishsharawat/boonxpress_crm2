  ...
  <div class="h-full overflow-y-auto pb-24">
    ...
    <div class="px-4 py-2">
      <div class="flex items-center justify-between mb-3">
        <h2 class="text-sm font-semibold text-boon-text-primary font-heading">Today's Treatments</h2>
        <button
...
const businessName = computed(() => config.value?.business_name || config.value?.display_name || 'Med Spa')
